...
from ansible_collections.vyatta.vyos.plugins.module_utils.network.vyos.argspec.facts.facts import FactsArgs
from ansible_collections.vyatta.vyos.plugins.module_utils.network.vyos.facts.facts import Facts
from ansible_collections.vyatta.vyos.plugins.module_utils.network.vyos.vyos import vyos_argument_spec
