...
from ansible_collections.vyatta.vyos.plugins.modules import vyos_system
...
class TestVyosSystemModule(TestVyosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.vyatta.vyos.plugins.modules.vyos_system.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.vyatta.vyos.plugins.modules.vyos_system.load_config')
